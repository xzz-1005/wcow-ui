<template>
	<div id="w-fullscreen">
		<!-- 切换全屏的插槽 -->
		<div @click="changeFull" class="fullscreen-change">
			<slot> </slot>
		</div>
		<!-- 全屏显示内容的插槽 -->
...
const changeFull = () => {
	let fullScrenStatus = document.fullscreenElement || document.msFullscreenElement || document.webkitFullscreenElement;
	let targetElement = document.getElementById("w-fullscreen") as FullScreenDocumentElement;
